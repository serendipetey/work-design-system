    ...
    const validationVariant = error
        ...
        : success
            ...
            : warning
                ? "warning"
                : "default";
    return (_jsxs("div", { className: cn(fieldVariants(), containerClassName), children: [hintText && (_jsx("p", { className: cn(helperVariants({ variant: "muted" }), "mb-2"), children: hintText })), _jsxs("div", { className: cn("flex items-center gap-2", className), id: sortControlsId, children: [_jsxs(SelectField, { value: selectValue, onValueChange: handleColumnChange, size: "md", disabled: disabled, hideLabel: true, placeholder: "Sort by column", className: "min-w-[160px]", ...formFieldAria, children: [_jsx(SelectItem, { value: "none", children: "No sorting" }), sortableColumns.map((column) => (_jsx(SelectItem, { value: column.key, children: column.header }, column.key)))] }), _jsx(Button, { variant: "ghost", size: "sm", leftIcon: _jsx(DirectionIcon, { direction: currentDirection }), onClick: handleDirectionToggle, disabled: disabled || !currentColumn, "data-icon-only": "true", "data-size": "sm", "aria-label": `Sort ${currentDirection === "asc" ? "ascending" : "descending"}` })] }), helperContent && (_jsx("p", { className: cn(helperVariants({ variant: helperVariant }), "mt-2", helperClassName), children: helperContent }))] }));
};
