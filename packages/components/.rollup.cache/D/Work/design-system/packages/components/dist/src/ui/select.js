...
const SelectTrigger = React.forwardRef(({ className, variant = "default", size = "md", children, ...props }, ref) => {
    ...
    return (_jsxs(SelectPrimitive.Trigger, { ref: elementRef, className: finalClassName, style: combinedStyles, ...props, children: [children, _jsx(SelectPrimitive.Icon, { asChild: true, children: _jsx(ChevronDown, { className: "h-4 w-4 opacity-50" }) })] }));
});
...
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, ref) => {
    ...
    return (_jsx(SelectPrimitive.Portal, { children: _jsxs(SelectPrimitive.Content, { ref: elementRef, className: cn(selectContentVariants(), className), style: combinedStyles, position: position, ...props, children: [_jsx(SelectPrimitive.ScrollUpButton, { className: "flex cursor-default items-center justify-center py-1", children: _jsx(ChevronUp, { className: "h-4 w-4" }) }), _jsx(SelectPrimitive.Viewport, { className: cn("p-1", position === "popper" &&
...
const SelectField = React.forwardRef(({ className, variant = "default", size = "md", label, labelState, hideLabel = false, hintText, helperText, error, success, warning, placeholder, value, onValueChange, defaultValue, children, required, disabled, id, name, containerClassName, labelClassName, helperClassName, ...props }, ref) => {
    ...
    return (_jsxs("div", { className: cn("w-full", containerClassName), children: [showLabel && label && (_jsxs("label", { htmlFor: selectId, className: cn(labelVariants({ variant: disabled ? "disabled" : "default" }), labelClassName), children: [label, labelState === "required" && (_jsxs("span", { style: { color: "var(--color-input-label-required, #a30134)" }, children: [" ", "*"] })), labelState === "optional" && (_jsxs("span", { style: {
                            color: "var(--color-text-muted, #6b7280)",
                            fontWeight: "var(--font-weight-regular, 400)",
                        }, children: [" ", "(Optional)"] }))] })), showHintText && (_jsx("p", { className: cn(helperVariants({ variant: "muted" })), id: `${selectId}-description`, children: hintText })), _jsxs(Select, { value: value, onValueChange: onValueChange, defaultValue: defaultValue, name: name, required: required, disabled: disabled, ...props, children: [_jsx(SelectTrigger, { ref: ref, id: selectId, variant: finalVariant, size: size, className: className, ...formFieldAria, children: _jsx(SelectValue, { placeholder: hasOptions ? placeholder : "No options available" }) }), _jsx(SelectContent, { children: hasOptions ? (children) : (_jsx("div", { className: "py-2 px-3 text-sm text-[var(--color-text-muted)]", children: "No options available" })) })] }), helperContent && (_jsx("p", { id: helperTextId, className: cn(helperVariants({ variant: helperVariant }), helperClassName), children: helperContent }))] }));
});
