// design-system/packages/components/src/ui/button-fixed.tsx
...
// Base button classes using ONLY Tailwind utilities that won't conflict
...
const createHoverCSS = () => {
  ...
  style.textContent = `
    ...
    .btn-fixed:focus {
      box-shadow: 0 0 0 2px var(--color-focus, #ff9900) !important;
    }
  `;
