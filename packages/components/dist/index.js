...
const Button = React__namespace.forwardRef(({ className, variant = "primary", size = "md", asChild = false, loading = false, leftIcon, rightIcon, children, disabled, style, ...props }, ref) => {
    ...
    return (jsxRuntime.jsxs(Comp, { className: cn(buttonVariants({ variant, size, className })), style: combinedStyle, ref: ref, disabled: isDisabled, ...props, children: [loading && jsxRuntime.jsx(Spinner, {}), !loading && leftIcon && (jsxRuntime.jsx("span", { className: "inline-flex items-center justify-center mr-2", children: leftIcon })), children, !loading && rightIcon && (jsxRuntime.jsx("span", { className: "inline-flex items-center justify-center ml-2", children: rightIcon }))] }));
});
