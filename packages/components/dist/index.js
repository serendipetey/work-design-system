...
const DataTable = ({ data, columns, title, description, className, variant = "default", size = "md", containerClassName, style, searchable = false, searchPlaceholder = "Search", onSearch, defaultSort, onSort, pagination = {}, rowActions = [], toolbarActions = [], footerActions = [], loading = false, emptyMessage = "No data available", striped = false, hoverable = true, getRowKey, ...props }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn(dataTableVariants({ variant, size }), className), style: {
            ...
            ...style,
                                            ...
                                            : String(row[column.key] || "") }, column.key))), hasActions && (jsxRuntime.jsx(TableCell, { children: jsxRuntime.jsx("div", { className: "flex justify-center gap-2", children: rowActions.map((action, actionIndex) => (jsxRuntime.jsx(Button, { variant: action.variant || "ghost", size: "sm", leftIcon: action.icon, "data-icon-only": "true", "data-size": "sm", onClick: () => action.onClick(row, index), className: cn(action.variant === "destructive" &&
...
const SidebarMenu = React.forwardRef(({ className, size = "md", collapsed = false, onToggleCollapse, children, style, ...props }, ref) => {
    ...
    className);
    return (jsxRuntime.jsx("div", { ...props, ref: ref, className: finalClassName, style: combinedStyles, role: "navigation", "aria-label": "Main navigation", children: children }));
});
...
exports.sidebarBusinessLogoVariants = sidebarBusinessLogoVariants$1;
