...
function createSidebarClasses({ size = "md", variant, className, isInContainer = false, }) {
...
function useLayoutDetection(ref) {
    ...
    React.useEffect(() => {
        ...
        const hasWidthConstraint = parentStyles.width !== "auto" &&
            parentStyles.width !== "" &&
        ...
        const hasWidthClass = Boolean(parent.className.match(/w-\d+|w-\[.*?\]|width:/));
        const inContainer = hasWidthConstraint || (isFlexContainer && hasWidthClass);
...
const sidebarMenuSectionVariants = cva("w-full", {
    variants: {},
    defaultVariants: {},
});
...
const sidebarBadgeVariants = cva([
    ...
    variants: {
        variant: {
            default: "bg-[var(--color-cta,#a30134)] text-[var(--color-white,#ffffff)]",
...
const SidebarMenu = React.forwardRef(({ className, size = "md", variant, collapsed = false, onToggleCollapse, children, style, ...props }, ref) => {
    ...
    const finalClassName = cn(createSidebarClasses({
        size,
        variant,
        isInContainer,
        className,
    ...
    className);
    return (jsxRuntime.jsx("div", { ...props, ref: refCallback, className: finalClassName, style: style, role: "navigation", "aria-label": "Main navigation", children: children }));
});
...
const Button = React__namespace.forwardRef(({ className, variant, appearance, size, asChild = false, loading = false, leftIcon, rightIcon, children, disabled, style, ghost, ...props }, ref) => {
    ...
    return (jsxRuntime.jsxs(Comp, { className: cn(buttonBaseClasses({ variant, appearance: resolvedAppearance, size }), "design-system-button", className), style: combinedStyles, "data-variant": variant, "data-appearance": resolvedAppearance, "data-size": size, "data-icon-only": isIconOnly ? "true" : undefined, ref: ref, disabled: isDisabled, ...props, children: [loading && (jsxRuntime.jsx("span", { className: cn(!isIconOnly && "mr-2"), children: jsxRuntime.jsx(Spinner$1, {}) })), !loading && leftIcon && (jsxRuntime.jsx("span", { className: cn("inline-flex items-center justify-center", !isIconOnly && "mr-2"), children: leftIcon })), children, !loading && rightIcon && (jsxRuntime.jsx("span", { className: cn("inline-flex items-center justify-center", !isIconOnly && "ml-2"), children: rightIcon }))] }));
});
...
const Checkbox = React.forwardRef(({ className, variant = "default", size = "md", label, labelState, showLabel = true, hintText, error, success, warning, containerClassName, labelClassName, helperClassName, checked, disabled, style, ...props }, ref) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn(fieldVariants(), containerClassName), children: [jsxRuntime.jsxs("div", { className: "flex items-start space-x-2", children: [jsxRuntime.jsx(Checkbox$1, { ref: elementRef, id: checkboxId, className: finalClassName, style: combinedStyles, checked: checked, disabled: disabled, ...formFieldAria, ...props, children: jsxRuntime.jsx(CheckboxIndicator, { className: "flex items-center justify-center text-current", children: checked === "indeterminate" ? (jsxRuntime.jsx(Minus, { className: "h-3 w-3" })) : (jsxRuntime.jsx(Check, { className: "h-3 w-3" })) }) }), label && showLabel && (jsxRuntime.jsx("label", { htmlFor: checkboxId, className: cn(
                        ...
                        "text-sm font-normal leading-normal cursor-pointer", {
                            ...
                            color: "var(--color-text-body, #39444f)",
                        }, children: label }))] }), helperContent && (jsxRuntime.jsx("p", { className: cn(helperVariants({ variant: helperVariant }), helperClassName), children: helperContent }))] }));
});
...
const RadioItem = React.forwardRef(({ className, itemClassName, labelClassName, variant = "default", size = "md", label, value, disabled, style, ...props }, ref) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn("flex items-center space-x-2", itemClassName), children: [jsxRuntime.jsx(Item2, { ref: elementRef, className: finalClassName, style: combinedStyles, value: value, disabled: disabled, ...props, children: jsxRuntime.jsx(Indicator, { className: "flex items-center justify-center", children: jsxRuntime.jsx("div", { className: "rounded-full bg-current", style: {
                            width: "6px",
                            height: "6px",
                            backgroundColor: "var(--color-navy-500, #1e3a8a)",
                        } }) }) }), label && (jsxRuntime.jsx("label", { htmlFor: props.id, className: cn(
...
const CheckboxGroup = React.forwardRef(({ containerClassName, labelClassName, helperClassName, label, labelState = "default", showLabel = true, hintText, error, success, warning, children, ...props }, ref) => {
    ...
    const helperContent = getHelperContent(error, success, warning);
    const helperVariant = getHelperVariant(error, success, warning);
    return (jsxRuntime.jsxs("div", { ref: ref, className: cn("space-y-2", containerClassName), ...props, children: [label && showLabel && (jsxRuntime.jsxs("div", { className: cn(labelVariants({ variant: "default" }), labelClassName), children: [label, labelState === "required" && (jsxRuntime.jsx("span", { className: "ml-1", style: { color: "var(--color-input-label-required, #a30134)" }, children: "*" })), labelState === "optional" && (jsxRuntime.jsx("span", { className: "ml-1", style: { color: "var(--color-input-label-optional, #6b7280)" }, children: "(Optional)" }))] })), hintText && (jsxRuntime.jsx("p", { className: cn(helperVariants({ variant: "muted" }), "mt-0 mb-0.5"), children: hintText })), jsxRuntime.jsx("div", { className: cn(fieldVariants({ variant: "compact" })), children: children }), helperContent && (jsxRuntime.jsx("p", { className: cn(helperVariants({ variant: helperVariant }), helperClassName), children: helperContent }))] }));
});
...
const DataTable = ({ data, columns, title, description, className, variant = "default", size = "md", containerClassName, style, searchable = false, searchPlaceholder = "Search", onSearch, defaultSort, onSort, pagination = {}, rowActions = [], toolbarActions = [], footerActions = [], loading = false, emptyMessage = "No data available", striped = false, hoverable = true, getRowKey, ...props }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn(dataTableVariants({ variant, size }), className), style: {
            ...dataTableStyles.base,
            ...(variant && dataTableStyles.variants[variant]),
            ...style,
        }, ...props, children: [(title || description) && (jsxRuntime.jsxs("div", { className: "space-y-2", children: [title && (jsxRuntime.jsx("h1", { className: "text-2xl font-bold text-[var(--color-navy-500)]", children: title })), description && (jsxRuntime.jsx("p", { className: "text-[var(--color-charcoal-500)] max-w-3xl", children: description }))] })), (searchable || hasSortableColumns || toolbarActions.length > 0) && (jsxRuntime.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center", children: [jsxRuntime.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-start sm:items-center", children: [searchable && (jsxRuntime.jsx("div", { className: "w-full sm:w-auto sm:min-w-[300px]", children: jsxRuntime.jsx(Input, { placeholder: searchPlaceholder, value: searchQuery, onChange: (e) => handleSearch(e.target.value), leftIcon: jsxRuntime.jsx(SearchIcon, {}), className: "w-full" }) })), hasSortableColumns && (jsxRuntime.jsx(ColumnSortControls, { columns: columns, currentColumn: sortField, currentDirection: sortDirection, onColumnChange: handleSortColumnChange, onDirectionChange: handleSortDirectionChange }))] }), toolbarActions.length > 0 && (jsxRuntime.jsx("div", { className: "flex gap-3", children: toolbarActions.map((action, index) => (jsxRuntime.jsx(Button, { variant: action.variant || "outline", appearance: action.appearance || "solid", onClick: action.onClick, leftIcon: action.icon, className: action.className, children: action.label }, index))) }))] })), jsxRuntime.jsx("div", { className: cn(dataTableContainerVariants(), containerClassName), style: dataTableStyles.container, children: loading ? (jsxRuntime.jsx("div", { className: dataTableEmptyStateVariants(), style: dataTableStyles.loadingState, children: "Loading..." })) : paginatedData.length === 0 ? (jsxRuntime.jsx("div", { className: dataTableEmptyStateVariants(), style: dataTableStyles.emptyState, children: emptyMessage })) : (jsxRuntime.jsxs(Table, { variant: striped ? "striped" : "default", children: [jsxRuntime.jsx(TableHeader, { children: jsxRuntime.jsxs(TableRow, { children: [columns.map((column) => (jsxRuntime.jsx(TableHead, { className: cn(column.className), style: column.width ? { width: column.width } : undefined, children: column.header }, column.key))), hasActions && (jsxRuntime.jsx(TableHead, { className: "text-center", children: "Action" }))] }) }), jsxRuntime.jsx(TableBody, { children: paginatedData.map((row, index) => (jsxRuntime.jsxs(TableRow, { variant: striped ? "striped" : "default", children: [columns.map((column) => (jsxRuntime.jsx(TableCell, { className: cn(column.className), children: column.render
                                            ? column.render(row[column.key], row, index)
                                            : String(row[column.key] || "") }, column.key))), hasActions && (jsxRuntime.jsx(TableCell, { children: jsxRuntime.jsx("div", { className: "flex justify-center gap-2", children: rowActions.map((action, actionIndex) => (jsxRuntime.jsx(Button, { variant: action.variant || "primary", appearance: action.appearance || "ghost", size: "sm", leftIcon: action.icon, "data-icon-only": "true", onClick: () => action.onClick(row, index), className: cn(action.variant === "destructive" &&
...
exports.SidebarMenuSectionRoot = SidebarMenuSectionRootComponent;
...
exports.createSidebarClasses = createSidebarClasses;
exports.fieldVariants = fieldVariants;
exports.getExpandedSectionsForPath = getExpandedSectionsForPath;
exports.getFormFieldAria = getFormFieldAria;
exports.getFormFieldIds = getFormFieldIds;
exports.getHelperContent = getHelperContent;
exports.getHelperVariant = getHelperVariant;
exports.getNavigationStats = getNavigationStats;
exports.getSidebarIconSize = getSidebarIconSize;
exports.getSidebarItemAriaLabel = getSidebarItemAriaLabel;
exports.getSidebarSectionAriaLabel = getSidebarSectionAriaLabel;
exports.hasValidationState = hasValidationState;
exports.helperVariants = helperVariants;
exports.inputVariants = inputVariants;
exports.isSidebarItemActive = isSidebarItemActive;
exports.labelVariants = labelVariants;
exports.optionalVariants = optionalVariants;
...
exports.requiredVariants = requiredVariants;
...
exports.sidebarToggleVariants = sidebarToggleVariants;
...
exports.useLayoutDetection = useLayoutDetection;
