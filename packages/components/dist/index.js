...
const Input = React.forwardRef(({ className, variant = "default", size = "md", label, labelState = "default", showLabel = true, hintText, showHintText = true, helperText, leftIcon, rightIcon, leftText, rightText, error, success, warning, loading = false, containerClassName, labelClassName, inputClassName, helperClassName, clearable = false, onClear, disabled, style, ...props }, ref) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn("w-full", containerClassName), children: [showLabel && label && (jsxRuntime.jsxs("label", { htmlFor: inputId, className: cn(labelClassName), style: {
                ...
                }, children: [jsxRuntime.jsx("span", { style: { color: "var(--color-navy-500, #1e40af)" }, children: label }), labelState === "required" && (jsxRuntime.jsxs("span", { style: { color: "var(--color-error-500, #dc2626)" }, children: [" ", "*"] })), labelState === "optional" && (jsxRuntime.jsxs("span", { style: { color: "var(--color-gray-500, #6b7280)" }, children: [" ", "(Optional)"] }))] })), showHintText && hintText && !displayHelperText && (jsxRuntime.jsx("p", { style: {
                    ...helperStyles.base,
                    ...helperStyles.variants.muted,
                    marginTop: showLabel && label ? "var(--spacing-1, 4px)" : "0",
                    marginBottom: "var(--spacing-1, 4px)",
                }, children: hintText })), jsxRuntime.jsxs("div", { className: "relative", children: [(leftIcon || leftText) && (jsxRuntime.jsxs("div", { className: "absolute left-3 top-1/2 transform -translate-y-1/2 flex items-center", style: { color: "var(--color-gray-500, #6b7280)" }, children: [leftIcon, leftText && jsxRuntime.jsx("span", { className: "text-sm", children: leftText })] })), jsxRuntime.jsx("input", { ...props, ref: elementRef, id: inputId, disabled: disabled, className: finalClassName, "aria-invalid": error ? "true" : undefined, "aria-describedby": helperTextId, style: {
                            ...combinedStyles,
                        ...
                        } }), jsxRuntime.jsxs("div", { className: "absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-2", children: [loading && (jsxRuntime.jsx("div", { style: { color: "var(--color-gray-500, #6b7280)" }, children: jsxRuntime.jsx(Spinner, {}) })), clearable && props.value && !disabled && !loading && (jsxRuntime.jsx("button", { type: "button", onClick: onClear, className: "hover:text-gray-700 focus:outline-none", style: { color: "var(--color-gray-500, #6b7280)" }, "aria-label": "Clear input", children: jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" }) }) })), (rightIcon || rightText) && !loading && !clearable && (jsxRuntime.jsxs("div", { className: "flex items-center", style: { color: "var(--color-gray-500, #6b7280)" }, children: [rightText && jsxRuntime.jsx("span", { className: "text-sm", children: rightText }), rightIcon] }))] })] }), displayHelperText && (jsxRuntime.jsx("p", { id: helperTextId, className: cn(helperClassName), style: {
                    ...helperStyles.base,
...
const SelectTrigger = React__namespace.forwardRef(({ className, variant, size, children, ...props }, ref) => (jsxRuntime.jsxs(Trigger$1, { ref: ref, className: cn(
    // Use input variants as base!
    inputVariants({ variant, size }), 
    // Add select-specific overrides
    selectTriggerVariants({ variant, size }), className), ...props, children: [children, jsxRuntime.jsx(Icon, { asChild: true, children: jsxRuntime.jsx(ChevronDown, { className: "h-4 w-4 opacity-50" }) })] })));
SelectTrigger.displayName = Trigger$1.displayName;
// Select Content with proper background
const SelectContent = React__namespace.forwardRef(({ className, children, position = "popper", ...props }, ref) => (jsxRuntime.jsx(Portal, { children: jsxRuntime.jsxs(Content2$1, { ref: ref, className: cn(selectContentVariants(), className), position: position, ...props, children: [jsxRuntime.jsx(ScrollUpButton, { className: "flex cursor-default items-center justify-center py-1", children: jsxRuntime.jsx(ChevronUp, { className: "h-4 w-4" }) }), jsxRuntime.jsx(Viewport, { className: cn("p-1", position === "popper" &&
...
const SelectItem = React__namespace.forwardRef(({ className, children, ...props }, ref) => (jsxRuntime.jsxs(Item$1, { ref: ref, className: cn(selectItemVariants(), className), ...props, children: [jsxRuntime.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator, { children: jsxRuntime.jsx(Check, { className: "h-4 w-4" }) }) }), jsxRuntime.jsx(ItemText, { children: children })] })));
SelectItem.displayName = Item$1.displayName;
const SelectField = React__namespace.forwardRef(({ className, variant, size, label, labelState = "default", showLabel = true, hintText, // ADDED: Hint text support
...
const Pagination = React__namespace.forwardRef(({ className, totalItems, currentPage, itemsPerPage, onPageChange, showResults = true, maxVisiblePages = 7, ...props }, ref) => {
    const totalPages = Math.ceil(totalItems / itemsPerPage);
    const pages = generatePageNumbers(currentPage, totalPages, maxVisiblePages);
    if (totalPages <= 1)
        return null;
    return (jsxRuntime.jsxs("nav", { ref: ref, role: "navigation", "aria-label": "pagination", className: cn("flex flex-col space-y-4", className), ...props, children: [showResults && (jsxRuntime.jsx(PaginationResults, { currentPage: currentPage, itemsPerPage: itemsPerPage, totalItems: totalItems })), jsxRuntime.jsxs("div", { className: cn(paginationVariants()), children: [jsxRuntime.jsx(PaginationPrevious, { onClick: () => onPageChange(currentPage - 1), disabled: currentPage === 1 }), pages.map((page, index) => page === "ellipsis" ? (jsxRuntime.jsx(PaginationEllipsis, {}, `ellipsis-${index}`)) : (jsxRuntime.jsx(PaginationItem, { page: page, isActive: page === currentPage, onClick: () => onPageChange(page) }, page))), jsxRuntime.jsx(PaginationNext, { onClick: () => onPageChange(currentPage + 1), disabled: currentPage === totalPages })] })] }));
});
Pagination.displayName = "Pagination";
const PaginationItem = React__namespace.forwardRef(({ className, isActive, page, variant, size, ...props }, ref) => (jsxRuntime.jsx("button", { ref: ref, className: cn(paginationItemVariants({
...
const PaginationPrevious = React__namespace.forwardRef(({ className, variant = "ghost", ...props }, ref) => (jsxRuntime.jsxs("button", { ref: ref, className: cn(paginationNavVariants({ variant }), className), "aria-label": "Go to previous page", ...props, children: [jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", className: "mr-1", children: jsxRuntime.jsx("path", { d: "M10 12L6 8L10 4", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }), "Previous"] })));
PaginationPrevious.displayName = "PaginationPrevious";
const PaginationNext = React__namespace.forwardRef(({ className, variant = "ghost", ...props }, ref) => (jsxRuntime.jsxs("button", { ref: ref, className: cn(paginationNavVariants({ variant }), className), "aria-label": "Go to next page", ...props, children: ["Next", jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", className: "ml-1", children: jsxRuntime.jsx("path", { d: "M6 4L10 8L6 12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })] })));
PaginationNext.displayName = "PaginationNext";
const PaginationEllipsis = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("span", { ref: ref, "aria-hidden": true, className: cn("flex h-8 w-8 items-center justify-center text-[var(--color-charcoal-500)]", className), ...props, children: "\u2026" })));
PaginationEllipsis.displayName = "PaginationEllipsis";
const PaginationResults = React__namespace.forwardRef(({ className, currentPage, itemsPerPage, totalItems, ...props }, ref) => {
    const startItem = (currentPage - 1) * itemsPerPage + 1;
    const endItem = Math.min(currentPage * itemsPerPage, totalItems);
    return (jsxRuntime.jsxs("div", { ref: ref, className: cn(paginationResultsVariants(), className), ...props, children: [jsxRuntime.jsx("span", { children: "Showing" }), jsxRuntime.jsx("strong", { children: startItem }), jsxRuntime.jsx("span", { children: "to" }), jsxRuntime.jsx("strong", { children: endItem }), jsxRuntime.jsx("span", { children: "of" }), jsxRuntime.jsx("strong", { children: totalItems }), jsxRuntime.jsx("span", { children: "results" })] }));
});
...
const SearchIcon = () => (jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: jsxRuntime.jsx("path", { d: "M7.333 12.667A5.333 5.333 0 1 0 7.333 2a5.333 5.333 0 0 0 0 10.667ZM14 14l-2.9-2.9", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }));
const EditIcon = () => (jsxRuntime.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: [jsxRuntime.jsx("path", { d: "M7.333 2.667H2.667A1.333 1.333 0 0 0 1.333 4v9.333A1.333 1.333 0 0 0 2.667 14.667H12a1.333 1.333 0 0 0 1.333-1.334V8", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M12.333 1.667a1.414 1.414 0 1 1 2 2L8 10l-2.667.667L6 8l6.333-6.333Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
const DeleteIcon = () => (jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: jsxRuntime.jsx("path", { d: "M2 4h12M5.333 4V2.667a1.333 1.333 0 0 1 1.334-1.334h2.666a1.333 1.333 0 0 1 1.334 1.334V4m2 0v9.333a1.333 1.333 0 0 1-1.334 1.334H4.667a1.333 1.333 0 0 1-1.334-1.334V4h8.667Z", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }));
...
function useDataTable(data, options = {}) {
    ...
    const [sortField, setSortField] = React__namespace.useState(options.defaultSort?.key || null);
    const [sortDirection, setSortDirection] = React__namespace.useState(options.defaultSort?.direction || "asc");
    ...
    const handleSortColumnChange = React__namespace.useCallback((key) => {
        setSortField(key);
        setCurrentPage(1); // Reset to first page
    }, []);
    // Handle sort direction change
    const handleSortDirectionChange = React__namespace.useCallback((direction) => {
...
const DataTable = ({ data, columns, title, description, className, searchable = true, searchPlaceholder = "Search", onSearch, defaultSort, onSort, pagination = {}, rowActions = [], toolbarActions = [], footerActions = [], loading = false, emptyMessage = "No data available", striped = false, hoverable = true, getRowKey, ...props }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cn("w-full space-y-6", className), ...props, children: [(title || description) && (jsxRuntime.jsxs("div", { className: "space-y-2", children: [title && (jsxRuntime.jsx("h1", { className: "text-2xl font-bold text-[var(--color-navy-500)]", children: title })), description && (jsxRuntime.jsx("p", { className: "text-[var(--color-charcoal-500)] max-w-3xl", children: description }))] })), (searchable || hasSortableColumns || toolbarActions.length > 0) && (jsxRuntime.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center", children: [jsxRuntime.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-start sm:items-center", children: [searchable && (jsxRuntime.jsx("div", { className: "w-full sm:w-auto sm:min-w-[300px]", children: jsxRuntime.jsx(Input, { placeholder: searchPlaceholder, value: searchQuery, onChange: (e) => handleSearch(e.target.value), leftIcon: jsxRuntime.jsx(SearchIcon, {}), className: "w-full" }) })), hasSortableColumns && (jsxRuntime.jsx(ColumnSortControls, { columns: columns, currentColumn: sortField, currentDirection: sortDirection, onColumnChange: handleSortColumnChange, onDirectionChange: handleSortDirectionChange }))] }), toolbarActions.length > 0 && (jsxRuntime.jsx("div", { className: "flex gap-3", children: toolbarActions.map((action, index) => (jsxRuntime.jsx(Button, { variant: action.variant || "outline", onClick: action.onClick, leftIcon: action.icon, className: action.className, children: action.label }, index))) }))] })), jsxRuntime.jsx("div", { className: "border border-[var(--color-border)] rounded-lg overflow-hidden", children: loading ? (jsxRuntime.jsx("div", { className: "flex items-center justify-center h-64", children: jsxRuntime.jsx("div", { className: "text-[var(--color-charcoal-500)]", children: "Loading..." }) })) : paginatedData.length === 0 ? (jsxRuntime.jsx("div", { className: "flex items-center justify-center h-64", children: jsxRuntime.jsx("div", { className: "text-[var(--color-charcoal-500)]", children: emptyMessage }) })) : (jsxRuntime.jsxs(Table, { variant: striped ? "striped" : "default", children: [jsxRuntime.jsx(TableHeader, { children: jsxRuntime.jsxs(TableRow, { children: [columns.map((column) => (jsxRuntime.jsx(TableHead, { className: cn(column.className), style: column.width ? { width: column.width } : undefined, children: column.header }, column.key))), hasActions && (jsxRuntime.jsx(TableHead, { className: "text-center", children: "Action" }))] }) }), jsxRuntime.jsx(TableBody, { children: paginatedData.map((row, index) => (jsxRuntime.jsxs(TableRow, { variant: striped ? "striped" : "default", children: [columns.map((column) => (jsxRuntime.jsx(TableCell, { className: cn(column.className), children: column.render
                                            ? column.render(row[column.key], row, index)
                                            : String(row[column.key] || "") }, column.key))), hasActions && (jsxRuntime.jsx(TableCell, { children: jsxRuntime.jsx("div", { className: "flex justify-center gap-2", children: rowActions.map((action, actionIndex) => (jsxRuntime.jsx(Button, { variant: action.variant || "ghost", size: "sm", onClick: () => action.onClick(row, index), className: action.className, disabled: action.disabled ? action.disabled(row) : false, "aria-label": `${action.label} row ${index + 1}`, children: action.icon || action.label }, actionIndex))) }) }))] }, getRowKey
                                ? getRowKey(row, index)
                                : `row-${currentPage}-${index}`))) })] })) }), showPagination && (jsxRuntime.jsx(Pagination, { totalItems: totalItems, currentPage: currentPage, itemsPerPage: pagination.pageSize || 10, onPageChange: handlePageChange, showResults: pagination.showResults, maxVisiblePages: pagination.maxVisiblePages })), footerActions.length > 0 && (jsxRuntime.jsx("div", { className: "flex justify-end gap-3", children: footerActions.map((action, index) => (jsxRuntime.jsx(Button, { variant: action.variant || "primary", onClick: action.onClick, leftIcon: action.icon, className: action.className, children: action.label }, index))) }))] }));
};
...
const createDefaultRowActions = (onEdit, onDelete) => {
    ...
    if (onDelete) {
        actions.push({
            label: "Delete",
            icon: jsxRuntime.jsx(DeleteIcon, {}),
            onClick: onDelete,
            variant: "ghost",
...
const SidebarMenu = React__namespace.forwardRef(({ className, children, size, mobile, mobileOpen = false, onMobileToggle, ...props }, ref) => {
    ...
    if (mobile === "overlay") {
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [mobileOpen && (jsxRuntime.jsx("div", { className: "fixed inset-0 bg-black/50 z-40 sm:hidden", onClick: handleBackdropClick, onKeyDown: handleKeyDown, role: "button", tabIndex: -1, "aria-label": "Close sidebar" })), jsxRuntime.jsx("nav", { ref: ref, className: cn(sidebarMenuVariants({ size, mobile }), mobileOpen
                        ? "translate-x-0"
    ...
    return (jsxRuntime.jsx("nav", { ref: ref, className: cn(sidebarMenuVariants({ size, mobile }), className), role: "navigation", "aria-label": "Main navigation", ...props, children: children }));
});
SidebarMenu.displayName = "SidebarMenu";
const SidebarToggle = React__namespace.forwardRef(({ className, open, onToggle, ...props }, ref) => {
    return (jsxRuntime.jsx("button", { ref: ref, onClick: () => onToggle(!open), className: cn("sm:hidden p-2 rounded-md text-[var(--color-text-body)]", "hover:bg-[var(--color-accent)] hover:text-[var(--color-accent-foreground)]", "focus-visible:outline-none focus-visible:bg-[var(--color-focus-500)]", "focus-visible:text-[var(--color-navy-500)]", className), "aria-label": open ? "Close navigation menu" : "Open navigation menu", "aria-expanded": open, ...props, children: jsxRuntime.jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: open ? (jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" })) : (jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6h16M4 12h16M4 18h16" })) }) }));
});
...
const SidebarProfile = React__namespace.forwardRef(({ className, user, onSwitchEntity, ...props }, ref) => {
    return (jsxRuntime.jsxs("div", { ref: ref, className: cn(sidebarProfileVariants(), className), ...props, children: [jsxRuntime.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [jsxRuntime.jsx("div", { className: "flex-shrink-0 mt-1", children: jsxRuntime.jsx("div", { className: "w-8 h-8 rounded-full bg-[var(--color-primary)] flex items-center justify-center", children: jsxRuntime.jsx(User, { className: "w-4 h-4 text-[var(--color-white)]" }) }) }), jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [jsxRuntime.jsx("h3", { className: "text-sm font-semibold text-[var(--color-text-heading)] truncate", children: user.entity.name }), jsxRuntime.jsx("p", { className: "text-sm text-[var(--color-text-body)] truncate", children: user.contact.name }), jsxRuntime.jsx("p", { className: "text-xs text-[var(--color-text-muted)] truncate", children: user.contact.role })] })] }), onSwitchEntity && (jsxRuntime.jsx(Button, { variant: "ghost", size: "sm", onClick: onSwitchEntity, leftIcon: jsxRuntime.jsx(ArrowUpDown, { className: "w-4 h-4" }), className: "justify-start text-[var(--color-text-link)] hover:text-[var(--color-text-link-hover)]", children: "Switch Entity" }))] }));
});
...
const SidebarMenuItem = React__namespace.forwardRef(({ className, icon: Icon, children, href, active, size, badge, onNavigate, asChild = false, disabled, ...props }, ref) => {
    const handleClick = (e) => {
        if (disabled)
            return;
        if (href && onNavigate) {
    ...
    const content = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [Icon && (jsxRuntime.jsx(Icon, { className: cn("flex-shrink-0", size === "sm" ? "w-3 h-3" : size === "lg" ? "w-5 h-5" : "w-4 h-4"), "aria-hidden": "true" })), jsxRuntime.jsx("span", { className: "truncate flex-1 min-w-0", children: children }), badge && (jsxRuntime.jsx("span", { className: cn("flex-shrink-0 ml-auto px-1.5 py-0.5 text-xs font-medium rounded-full", "bg-[var(--color-red-500)] text-[var(--color-white)]", size === "sm" ? "text-xs px-1 py-0.5" : "text-xs px-1.5 py-0.5"), "aria-label": `${badge} pending items`, children: badge }))] }));
    const commonProps = {
...
const SidebarMenuSectionRoot = React__namespace.forwardRef(({ className, type = "multiple", collapsible = true, children, value, onValueChange, ...props }, ref) => {
    if (type === "single") {
        return (jsxRuntime.jsx(Root2, { ref: ref, type: "single", collapsible: collapsible, value: typeof value === "string" ? value : undefined, onValueChange: onValueChange, className: cn("w-full", className), ...props, children: children }));
    }
    return (jsxRuntime.jsx(Root2, { ref: ref, type: "multiple", value: Array.isArray(value) ? value : [], onValueChange: onValueChange, className: cn("w-full", className), ...props, children: children }));
});
SidebarMenuSectionRoot.displayName = "SidebarMenuSectionRoot";
const SidebarMenuSection = React__namespace.forwardRef(({ className, title, icon: Icon, children, value, expanded, onToggle, badge, }, ref) => {
    ...
    return (jsxRuntime.jsxs(Item, { ref: ref, className: cn(sidebarMenuSectionVariants(), className), value: sectionValue, children: [jsxRuntime.jsx(Header, { children: jsxRuntime.jsxs(Trigger2, { className: cn(sidebarMenuSectionTriggerVariants()), onClick: () => onToggle?.(!expanded), "aria-label": getAriaLabel(), "aria-expanded": expanded, children: [jsxRuntime.jsxs("div", { className: "flex items-center gap-3 flex-1 min-w-0", children: [Icon && (jsxRuntime.jsx(Icon, { className: "w-4 h-4 flex-shrink-0", "aria-hidden": "true" })), jsxRuntime.jsx("span", { className: "truncate font-semibold", children: title }), badge && (jsxRuntime.jsx("span", { className: "flex-shrink-0 ml-auto px-1.5 py-0.5 text-xs font-medium rounded-full bg-[var(--color-red-500)] text-[var(--color-white)]", "aria-label": `${badge} items in ${title} section`, children: badge }))] }), jsxRuntime.jsx(ChevronDown, { className: "h-4 w-4 shrink-0 transition-transform duration-200 group-data-[state=open]:rotate-180", "aria-hidden": "true" })] }) }), jsxRuntime.jsx(Content2, { className: cn(sidebarMenuSectionContentVariants()), role: "region", "aria-labelledby": `section-${sectionValue}`, children: jsxRuntime.jsx("div", { className: "pt-1 pb-3 px-2", children: children }) })] }));
});
...
const SidebarBusinessLogo = React__namespace.forwardRef(({ className, businessName = "Your Business", logoUrl, width = 120, height = 40, onClick, ...props }, ref) => {
    const isClickable = !!onClick;
    const logoContent = logoUrl ? (jsxRuntime.jsx("img", { src: logoUrl, alt: `${businessName} logo`, width: width, height: height, className: "max-w-full h-auto object-contain", style: { maxHeight: height } })) : (
    // Placeholder when no logo provided
    jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [jsxRuntime.jsx("div", { className: "w-8 h-8 rounded bg-[var(--color-navy-500)] flex items-center justify-center", children: jsxRuntime.jsx(Building2, { className: "w-5 h-5 text-[var(--color-white)]" }) }), jsxRuntime.jsx("span", { className: "text-lg font-bold text-[var(--color-navy-500)] truncate max-w-[140px]", children: businessName })] }));
    ...
    if (isClickable) {
        return (jsxRuntime.jsx("button", { ref: ref, onClick: onClick, "aria-label": `${businessName} home`, className: commonClassName, ...props, children: logoContent }));
    }
    return (jsxRuntime.jsx("div", { ref: ref, className: commonClassName, ...props, children: logoContent }));
});
...
function useActiveNavigation(currentPath, matchMode = "startsWith") {
    const isActive = React__namespace.useCallback((href) => {
        if (!href || !currentPath)
            return false;
        if (matchMode === "exact") {
    ...
    const findActiveItem = React__namespace.useCallback((config) => {
...
function useNavigationState(config, currentPath) {
    ...
    const [expandedSections, setExpandedSections] = React__namespace.useState(() => {
    ...
    const activeItemId = React__namespace.useMemo(() => findActiveItem(config), [config, findActiveItem]);
    const toggleSection = React__namespace.useCallback((sectionId) => {
        setExpandedSections((prev) => prev.includes(sectionId)
            ? prev.filter((id) => id !== sectionId)
            : [...prev, sectionId]);
    }, []);
    const isSectionExpanded = React__namespace.useCallback((sectionId) => expandedSections.includes(sectionId), [expandedSections]);
    return {
        activeItemId,
        expandedSections,
        toggleSection,
...
exports.ColumnSortControls = ColumnSortControls;
...
exports.SidebarBusinessLogo = SidebarBusinessLogo;
exports.SidebarMenu = SidebarMenu;
exports.SidebarMenuItem = SidebarMenuItem;
exports.SidebarMenuSection = SidebarMenuSection;
exports.SidebarMenuSectionRoot = SidebarMenuSectionRoot;
...
exports.buttonVariants = buttonBaseClasses;
exports.cn = cn;
exports.createDefaultRowActions = createDefaultRowActions;
exports.helperVariants = helperVariants;
exports.inputVariants = inputVariants;
exports.labelVariants = labelVariants;
exports.paginationItemVariants = paginationItemVariants;
exports.paginationNavVariants = paginationNavVariants;
exports.paginationResultsVariants = paginationResultsVariants;
...
exports.sidebarMenuSectionTriggerVariants = sidebarMenuSectionTriggerVariants;
exports.sidebarMenuSectionVariants = sidebarMenuSectionVariants;
exports.sidebarMenuVariants = sidebarMenuVariants;
exports.sidebarProfileVariants = sidebarProfileVariants;
exports.tableBodyVariants = tableBodyVariants;
