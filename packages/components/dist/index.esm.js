...
const Button = React.forwardRef(({ className, variant = "primary", size = "md", asChild = false, loading = false, leftIcon, rightIcon, children, disabled, style, ...props }, ref) => {
    ...
    return (jsxs(Comp, { className: cn(buttonVariants({ variant, size, className })), style: combinedStyle, ref: ref, disabled: isDisabled, ...props, children: [loading && jsx(Spinner, {}), !loading && leftIcon && (jsx("span", { className: "inline-flex items-center justify-center mr-2", children: leftIcon })), children, !loading && rightIcon && (jsx("span", { className: "inline-flex items-center justify-center ml-2", children: rightIcon }))] }));
});
