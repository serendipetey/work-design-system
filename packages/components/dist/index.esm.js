...
const ButtonOld = React.forwardRef(({ className, variant, size, asChild = false, loading = false, leftIcon, rightIcon, children, disabled, ...props }, ref) => {
    const Comp = asChild ? Slot$1 : "button";
    const isDisabled = disabled || loading;
    return (jsxs(Comp, { className: cn(buttonVariants({ variant, size, className })), ref: ref, disabled: isDisabled, ...props, children: [loading && jsx(Spinner$1, {}), !loading && leftIcon && (jsx("span", { className: "inline-flex items-center justify-center", children: leftIcon })), children, !loading && rightIcon && (jsx("span", { className: "inline-flex items-center justify-center", children: rightIcon }))] }));
});
...
const Input = React.forwardRef(({ className, containerClassName, labelClassName, inputClassName, helperClassName, type = "text", variant, size, label, labelState = "default", showLabel = true, hintText, showHintText = true, helperText, leftIcon, rightIcon, leftText, rightText, error, success, warning, loading, clearable, onClear, value, disabled, ...props }, ref) => {
    ...
    const ClearIcon = () => (jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: "h-4 w-4", children: jsx("path", { d: "M18 6L6 18M6 6l12 12" }) }));
    // Loading spinner component
    const LoadingSpinner = () => (jsxs("svg", { className: "animate-spin h-4 w-4 text-[var(--color-text-muted)]", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] }));
    return (jsxs("div", { className: cn("space-y-2", containerClassName), children: [showLabel && label && (jsxs("div", { className: "flex items-center gap-1", children: [jsx("label", { htmlFor: inputId, className: cn(labelVariants({
                            state: disabled ? "disabled" : labelState,
                        }), labelClassName), children: label }), labelState === "required" && (jsx("span", { className: "text-[var(--color-input-label-required)] text-sm", children: "(Required)" })), labelState === "optional" && (jsx("span", { className: "text-[var(--color-input-label-optional)] text-sm", children: "(Optional)" }))] })), showHintText && hintText && (jsx("p", { className: cn(helperVariants({ variant: "muted" })), children: hintText })), jsxs("div", { className: "relative", children: [hasLeftContent && (jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-navy-500)] text-sm font-medium", children: leftIcon || leftText })), jsx("input", { id: inputId, type: type, ref: ref, value: value, disabled: disabled || loading, "aria-invalid": !!error, "aria-describedby": helperContent ? helperTextId : undefined, className: cn(inputVariants({ variant: currentVariant, size }), hasLeftContent && "pl-10", hasRightContent && "pr-10", className, inputClassName), ...props }), jsxs("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2", children: [loading && jsx(LoadingSpinner, {}), showClear && (jsx("button", { type: "button", onClick: onClear, className: "text-[var(--color-navy-500)] hover:text-[var(--color-navy-600)] transition-colors", "aria-label": "Clear input", children: jsx(ClearIcon, {}) })), rightText && !loading && !showClear && (jsx("span", { className: "text-[var(--color-navy-500)] text-sm font-medium", children: rightText })), rightIcon && !loading && !showClear && !rightText && (jsx("div", { className: "text-[var(--color-navy-500)]", children: rightIcon }))] })] }), helperContent && (jsx("p", { id: helperTextId, className: cn(helperVariants({ variant: helperVariant }), helperClassName), children: helperContent }))] }));
});
...
// Table Components
const Table = React.forwardRef(({ className, variant, size, ...props }, ref) => (jsx("div", { className: "relative w-full overflow-auto", children: jsx("table", { ref: ref, className: cn(tableVariants({ variant, size }), className), ...props }) })));
Table.displayName = "Table";
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (jsx("thead", { ref: ref, className: cn(tableHeaderVariants(), className), ...props })));
TableHeader.displayName = "TableHeader";
const TableBody = React.forwardRef(({ className, ...props }, ref) => (jsx("tbody", { ref: ref, className: cn(tableBodyVariants(), className), ...props })));
TableBody.displayName = "TableBody";
const TableRow = React.forwardRef(({ className, variant, ...props }, ref) => (jsx("tr", { ref: ref, className: cn(tableRowVariants({ variant }), className), ...props })));
...
const TableHead = React.forwardRef(({ className, sortable, sortDirection, onSort, children, ...props }, ref) => {
    ...
    return (jsx("th", { ref: ref, className: cn(tableHeadVariants({ sortable }), className), onClick: handleSort, ...props, children: jsxs("div", { className: "flex items-center space-x-2", children: [jsx("span", { children: children }), sortable && (jsx("span", { className: "ml-2", children: jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", className: cn("fill-[var(--color-navy-500)] transition-transform duration-150", sortDirection === "desc" ? "rotate-180" : "rotate-0", !sortDirection && "opacity-40"), children: jsx("path", { d: "M8 2L6 6h1.5v8h1v-8H10L8 2z" }) }) }))] }) }));
});
TableHead.displayName = "TableHead";
const TableCell = React.forwardRef(({ className, size, ...props }, ref) => (jsx("td", { ref: ref, className: cn(tableCellVariants({ size }), className), ...props })));
...
const PaginationItem = React.forwardRef(({ className, isActive, page, variant, size, ...props }, ref) => (jsx("button", { ref: ref, className: cn(paginationItemVariants({
...
const PaginationPrevious = React.forwardRef(({ className, variant = "ghost", ...props }, ref) => (jsxs("button", { ref: ref, className: cn(paginationNavVariants({ variant }), className), "aria-label": "Go to previous page", ...props, children: [jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", className: "mr-1", children: jsx("path", { d: "M10 12L6 8L10 4", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }), "Previous"] })));
PaginationPrevious.displayName = "PaginationPrevious";
const PaginationNext = React.forwardRef(({ className, variant = "ghost", ...props }, ref) => (jsxs("button", { ref: ref, className: cn(paginationNavVariants({ variant }), className), "aria-label": "Go to next page", ...props, children: ["Next", jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", className: "ml-1", children: jsx("path", { d: "M6 4L10 8L6 12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })] })));
...
const Spinner = () => (jsx("div", { className: "w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin" }));
...
const ColumnSortControls = ({ columns, currentColumn, currentDirection = "asc", onColumnChange, onDirectionChange, className, disabled = false, }) => {
    ...
    return (jsxs("div", { className: cn("flex items-center gap-2", className), children: [jsxs(SelectField, { value: selectValue, onValueChange: handleColumnChange, size: "md", disabled: disabled, showLabel: false, placeholder: "Sort by column", className: "min-w-[160px]", children: [jsx(SelectItem, { value: "none", children: "No sorting" }), sortableColumns.map((column) => (jsx(SelectItem, { value: column.key, children: column.header }, column.key)))] }), jsx(Button, { variant: "ghost", size: "md", onClick: handleDirectionToggle, disabled: disabled || !currentColumn, "aria-label": `Sort ${currentDirection === "asc" ? "ascending" : "descending"}`, className: "px-3", children: jsx(DirectionIcon, { direction: currentDirection }) })] }));
};
...
export { ButtonOld, ColumnSortControls, DataTable, Input, Pagination, PaginationEllipsis, PaginationItem, PaginationNext, PaginationPrevious, PaginationResults, Select, SelectContent, SelectField, SelectGroup, SelectItem, SelectTrigger, SelectValue, SidebarBusinessLogo, SidebarMenu, SidebarMenuItem, SidebarMenuSection, SidebarMenuSectionRoot, SidebarProfile, SidebarToggle, Table, TableBody, TableCell, TableHead, TableHeader, TableRow, buttonVariants, cn, createDefaultRowActions, helperVariants, inputVariants, labelVariants, paginationItemVariants, paginationNavVariants, paginationResultsVariants, paginationVariants, sidebarBusinessLogoVariants, sidebarMenuItemVariants, sidebarMenuSectionContentVariants, sidebarMenuSectionTriggerVariants, sidebarMenuSectionVariants, sidebarMenuVariants, sidebarProfileVariants, tableBodyVariants, tableCellVariants, tableHeadVariants, tableHeaderVariants, tableRowVariants, tableVariants, useActiveNavigation, useDataTable, useNavigationState };
